  ...
  <div class="q-pa-md" v-if="CheckRole('ReservationCreate')">
    <q-card>
      <q-card-section class="row justify-center">
        <div class="text-h6">Rezervasyon Formu *</div>
      </q-card-section>
      <q-card-section class="row justify-center">
      <div class="column mrl">
        <q-select
          v-model="transfer_type_model"
          label="Transfer Tipi"
          filled emit-value dense options-dense
          option-label="name"
      ...
      <div class="column mrl">
        <q-select
          ...
          emit-value dense options-dense filled
          option-label="name"
          @input="getAreas"
      ...
      <q-card-section class="row justify-center">
        <div class="column mrl" >
          <q-select
            ...
            filled emit-value dense options-dense
            option-label="area_name" label="Kalkış bölgesi seçiniz."
            style="overflow: hidden"
            input-style="max-width:250px;overflow:hidden;"
            @input="ChangeArea" :options="nereden"
            v-if="transfer_direction_model.id!=0"
          />
        </div>
        <div class="column mrl">
          <q-select
            ...
            input-style="max-width:250px;overflow:hidden;"
            @input="ChangeArea" :options="nereye"
            v-if="transfer_direction_model.id!=0"
          />
        </div>
      <div class="column mrl" v-if="hotel!=null">
      <q-select
        filled
        emit-value
        options-dense
        ...
        label="Otel seçiniz."
        color="primary"
        input-style="max-width:250px;overflow:hidden;" style="margin-bottom:20px"
        @input="hotelChange"
        @filter="hotelFiltre"
      ...
      <q-card-section class="row justify-center">
        ...
        <div class="column mrl">
          <q-select
            filled
            emit-value dense  options-dense
            v-model="car_model"
      ...
      <q-card-section class="flex justify-center">
        <div v-for="n in this.passengers.length" :key="n">
          <div class="row">
          <div class="column mrl3" style="width:100px;">
    ...
    <q-card-section class="row justify-center">
      ...
      <q-card-section v-if="people_number>0">
        <div style="display:flex;flex-flow:row wrap;flex-basis: 300px;justify-content: center">
      ...
      <q-card-section class="row justify-center" v-if="departure_time">
  ...
  export default {
    ...
    methods: {
      ...
      ChangeArea(){
        ...
        if(this.nereye_model!=null && this.nereden_model!=null){
          this.getCars()
        }
      ...
      getAreas () {
        if(this.transfer_direction_model.id==0){
          return false;
        }
        if(this.CheckRole('ReservationCreate')==false){
          return false
...
.mrl {
  ...
  .passengerInput:focus {
    border-bottom: 3px outset var(--q-color-primary);
  }
</style>
